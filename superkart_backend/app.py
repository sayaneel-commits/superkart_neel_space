...
def predict_sales():
    try:
        ...
        sample = {
            ...
            'Product_ID_Type': str(data['Product_Id_char']),      # Mapped to training name
            'Store_Age': int(data['Store_Age_Years']),            # Mapped to training name
            'Product_Perishability': str(data['Product_Type_Category']) # Mapped to training name
        }
